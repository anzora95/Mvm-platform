...
//        return View('MachineryAvailability.AvailabilityCalendar')->with('rentas',$re)->with('machin', $machi)->with('today',$today)->with('today_f', $today_format)->with('inyard',$no_rents_today)->with('out',$rents_today)->with('next',$next)->with('previous',$previous);
        ...
        return View('DispachCenter.dispatch_center')->with('today',$today)->with('today_format',$today_format)->with('next',$next)->with('previous',$previous)->with('machi',$machi)->with('out',$rents_today)->with('rentals',$re)->with('inyard',$no_rents_today)->with('out',$rents_today);
